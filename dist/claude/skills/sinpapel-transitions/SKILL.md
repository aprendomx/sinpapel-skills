...
|---|---|---|
| `PermissionError` | Cualquier bloqueo de `puede_cambiar_estado`: el usuario no pertenece a ningún `grupos_permitidos`, un predicado falla, o (desde 0.6.0) falta un requisito documental. Lleva el `mensaje` del primer bloqueo. | 403 |
